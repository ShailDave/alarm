...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.shail.ws.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost:8080/DynamicWebServ/services/HelloWorld";
    ...
    public com.shail.ws.HelloWorld getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public com.shail.ws.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.shail.ws.HelloWorldSoapBindingStub _stub = new com.shail.ws.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.shail.ws.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                com.shail.ws.HelloWorldSoapBindingStub _stub = new com.shail.ws.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ws.shail.com", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ws.shail.com", "HelloWorld"));
        }
